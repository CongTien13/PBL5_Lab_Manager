...
def main():
    ...
    print("[INFO] Quét mặt trong 8 giây...")
    ...
    final_count = vote_count[final_name]
    avg_score = score_sum[final_name] / final_count

    print(f"[SUCCESS] Người được nhận diện nhiều nhất: {final_name}")
